...
export const metadata = {
  title: 'Keibai Lens - Tiện Ích Mở Rộng Quét X-Quang Bất Động Sản',
  description: 'Tải ngay Keibai Lens (Miễn Phí). Siêu công cụ tự động quét giá trị thị trường thực tế và bản đồ ngập lụt, sạt lở (MLIT) trên SUUMO, HOMES chỉ với 1 Click.',
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 font-sans selection:bg-indigo-500/30">
      ...
      <header className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100/50 text-blue-700 text-sm font-bold border border-blue-200">
            ...
            Sản phẩm chính thức từ Keibai-Koubai
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-600 font-medium max-w-2xl mx-auto">
            Vũ khí X-Quang Tối Thượng Dành Cho Nhà Đầu Tư BĐS Nhật Bản.
          </p>

          <p className="text-sm md:text-base text-slate-500 max-w-3xl mx-auto leading-relaxed mt-4">
            Bạn định mua nhà trên các Cổng thông tin BĐS lớn? Đừng để bị "lùa gà" bởi giá ảo. Cài đặt ngay Extension để soi thẳng vào <strong>Giá Giao Dịch Cốt Lõi của (MLIT)</strong> và bóc trần <strong>Bản Đồ Thảm Họa (Ngập lụt, Sạt lở)</strong> chỉ trong 1 giây.
          </p>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              Cài đặt lên Google Chrome
            </a>
            <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider">Hoàn toàn miễn phí</span>
          </div>
        </div>
      </header>
      ...
      <section className="py-12 max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">Đo lường Định giá</h3>
             <p className="text-slate-600 text-sm leading-relaxed">Xóa mù thông tin giá bẩn. Lens lấy dữ liệu từ Cục Thuế Quốc gia (NTA) & tòa án (BIT) & Bộ Đất đai (MLIT) để phân tích cho bạn.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">Radar Thảm Họa (Hazard)</h3>
             <p className="text-slate-600 text-sm leading-relaxed">Phát hiện ngay Căn nhà bạn đang xem có lọt thỏm giữa Vùng Rốn Ngập Lụt, Vùng Cảnh báo Sạt lở núi, hay Sóng thần không.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">Phát hiện BĐS Đấu giá (Keibai)</h3>
             <p className="text-slate-600 text-sm leading-relaxed">Tự động báo động nếu xung quanh tọa độ căn nhà đang định mua có xuất hiện "Tài sản Đấu giá" rẻ hơn thị trường 30%!</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-8 text-center border-t border-slate-200 mt-12 bg-white">
        <p className="text-sm text-slate-500">
           © 2026 Keibai Finder. Để đảm bảo tính minh bạch, vui lòng đọc <Link href="/extension/privacy" className="text-indigo-600 hover:underline font-medium">Chính sách Bảo mật (Privacy Policy)</Link> của chúng tôi.
        </p>
      </footer>
    </div>
  );
