...
export const metadata = {
  title: 'Keibai Lens - Real Estate X-Ray Scan Extension',
  description: 'Download Keibai Lens (Free). The ultimate tool that automatically analyzes real market values and hazard maps (MLIT) on SUUMO and HOMES with just 1 Click.',
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 font-sans selection:bg-indigo-500/30">
      ...
      <header className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100/50 text-blue-700 text-sm font-bold border border-blue-200">
            ...
            Official Product by Keibai-Koubai
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-600 font-medium max-w-2xl mx-auto">
            The Ultimate X-Ray Weapon for Real Estate Investors in Japan.
          </p>

          <p className="text-sm md:text-base text-slate-500 max-w-3xl mx-auto leading-relaxed mt-4">
            Planning to buy property on major real estate portals? Don't be fooled by inflated prices. Install the Extension now to see through to the <strong>Core Transaction Prices (MLIT)</strong> and uncover <strong>Hazard Maps (Flood, Landslide)</strong> risks in just 1 second.
          </p>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider">Completely Free</span>
          </div>
        </div>
      </header>
      ...
      <section className="py-12 max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">AI Valuation & Price Analysis</h3>
             <p className="text-slate-600 text-sm leading-relaxed">Eliminate opaque pricing. Lens instantly integrates and analyzes public data from the National Tax Agency (NTA), Courts (BIT), and Ministry of Land (MLIT).</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">Hazard Radar (Disaster Forecast)</h3>
             <p className="text-slate-600 text-sm leading-relaxed">Instantly detects if the property you are viewing falls within Flood Inundation Zones, Landslide Warning Areas, or Tsunami Risk Areas.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">Foreclosure (Keibai) Auto-Detection</h3>
             <p className="text-slate-600 text-sm leading-relaxed">Automatically triggers an alert if a "Foreclosure Property" appears near your target property at 30% below market price!</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-8 text-center border-t border-slate-200 mt-12 bg-white">
        <p className="text-sm text-slate-500">
           © 2026 Keibai Finder. To ensure transparency, please read our <Link href="/extension/privacy" className="text-indigo-600 hover:underline font-medium">Privacy Policy</Link>.
        </p>
      </footer>
    </div>
  );
