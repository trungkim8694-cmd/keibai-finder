...
export const metadata = {
  title: 'Keibai Lens - 房地产 X 射线扫描扩展程序',
  description: '免费下载 Keibai Lens。只需一键即可在 SUUMO 和 HOME\'S 上自动解析真实市场价格和灾害地图（洪水、滑坡）的终极工具。',
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 font-sans selection:bg-indigo-500/30">
      ...
      <header className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-xl md:text-2xl text-slate-600 font-medium max-w-2xl mx-auto">
            日本房地产投资者的终极 X 射线扫描武器。
          </p>

          <p className="text-sm md:text-base text-slate-500 max-w-3xl mx-auto leading-relaxed mt-4">
            准备在大型房产网站上买房？不要被虚高价格欺骗。立即安装扩展程序，仅需 1 秒即可透视<strong>国土交通省（MLIT）的核心交易价格</strong>，并揭示<strong>灾害地图（洪水、滑坡）</strong>的风险。
          </p>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider">完全免费</span>
          </div>
        </div>
      </header>
      ...
      <section className="py-12 max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">AI 估值与价格分析</h3>
             <p className="text-slate-600 text-sm leading-relaxed">消除不透明的价格信息。Lens 瞬间整合并分析来自国税厅 (NTA)、法院 (BIT) 和国土交通省 (MLIT) 的公开数据。</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">灾害雷达 (灾害预测)</h3>
             <p className="text-slate-600 text-sm leading-relaxed">立即检测您查看的房产是否位于洪水淹没区、滑坡警告区或海啸危险区内。</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
             ...
             <h3 className="text-xl font-bold text-slate-900 mb-2">法拍房 (Keibai) 自动检测</h3>
             <p className="text-slate-600 text-sm leading-relaxed">如果目标房产周围出现比市场价低 30% 的“法拍房”，则自动触发警报！</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-8 text-center border-t border-slate-200 mt-12 bg-white">
        <p className="text-sm text-slate-500">
           © 2026 Keibai Finder. 为了确保透明度，请阅读我们的<Link href="/extension/privacy" className="text-indigo-600 hover:underline font-medium">隐私政策 (Privacy Policy)</Link>。
        </p>
      </footer>
    </div>
  );
