...
export function AsyncStationInfo({ lat, lng, initial, hideIfNoStation = false }: AsyncStationInfoProps) {
  ...
  }, [lat, lng, initial, hideIfNoStation]);
