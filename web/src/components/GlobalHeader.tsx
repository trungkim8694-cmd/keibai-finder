...
export default async function GlobalHeader() {
  ...
  return (
    <header className="sticky top-0 z-[10000] bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 px-4 py-3 lg:py-2 flex items-center justify-between shadow-sm">
       <Link href="/" className="text-lg lg:text-base font-bold flex items-center shrink-0">
          <span className="text-blue-600 dark:text-blue-500">Keibai</span><span className="text-red-600 dark:text-red-500">Kobai</span><span className="text-zinc-900 dark:text-white">Finder</span>
       </Link>
